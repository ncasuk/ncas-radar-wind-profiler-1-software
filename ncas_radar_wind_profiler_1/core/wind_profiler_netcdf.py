...
netcdf_file_location = '/gws/nopw/j04/ncas_obs/cdao/processing/ncas-radar-wind-profiler-1/netcdf_files'
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output-location", dest = "outloc", default = "/gws/nopw/j04/ncas_obs/cdao/processing/ncas-radar-wind-profiler-1/netcdf_files", help = "Location for netCDF file")
